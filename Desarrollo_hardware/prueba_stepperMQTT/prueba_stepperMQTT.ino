...
const char* ssid = "ARRIS-D232";//"your_wifi_hotspot";
const char* password = "doggo1213";//"your_wifi_password";
 const char* mqtt_server = "192.168.0.16";//"broker.mqttdashboard.com";
